...
const TablaDinamicaMonitoreoFauna = ({ titulo, columnas, data, rutaNuevo, rutaVisualizar, rutaEliminar, rutaAgregarImg }) => {
  const navigate = useNavigate();
  const [open, setOpen] = useState(false);
  const [selectedId, setSelectedId] = useState(null);

  const handleAddImg = (id) =>{
    //Redirigir a laboratorio
    console.log(`Formulario para agregar imagenes, monitoreo con ID: ${rutaAgregarImg} / ${id} `);
    navigate(rutaAgregarImg)
  }
...
export default TablaDinamicaMonitoreoFauna;
