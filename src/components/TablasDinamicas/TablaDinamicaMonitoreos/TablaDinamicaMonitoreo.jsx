...
import { FaEye, FaEdit, FaTrash, FaPlusCircle, FaFlask } from 'react-icons/fa';
import { useNavigate } from 'react-router-dom';

const TablaDinamicaMonitoreo = ({ titulo, columnas, data, ruta, rutaEliminar, rutaLaboratorio }) => {
...
export default TablaDinamicaMonitoreo;
